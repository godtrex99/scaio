...
wget -q -O /root/.config/rclone/rclone.conf "https://raw.githubusercontent.com/godtrex99/scaio/main/backup/rclone.conf"
...
wget -q -O /usr/bin/backup "https://raw.githubusercontent.com/godtrex99/scaio/main/backup/backup.sh" && chmod +x /usr/bin/backup
wget -q -O /usr/bin/restore "https://raw.githubusercontent.com/godtrex99/scaio/main/backup/restore.sh" && chmod +x /usr/bin/restore
wget -q -O /usr/bin/cleaner "https://raw.githubusercontent.com/godtrex99/scaio/main/backup/logcleaner.sh" && chmod +x /usr/bin/cleaner
